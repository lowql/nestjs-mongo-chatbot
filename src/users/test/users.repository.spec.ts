    ...
    describe("find operations", () => {
        ...
        describe("find", () => {
            describe("when find is called", () => {
                ...
                test('then it should call the userModel', () => {
                    expect(userModel.find).toHaveBeenLastCalledWith(userFilterQuery);
                })
        ...
        describe("findOneAndUpdate", () => {
            describe('when findOneAndUpdate is called', () => {
                ...
                test('then it should call the userModel', () => {
                    expect(userModel.findOneAndUpdate).toHaveBeenLastCalledWith(userFilterQuery, userStub(), { new: true });
                });
